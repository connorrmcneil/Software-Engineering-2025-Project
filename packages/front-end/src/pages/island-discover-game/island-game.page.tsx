...
import { ANIMALS, GAME_LEVELS, FINISH_MAP } from './island-data'
...
export function IslandGamePage() {
  ...
  const quizOptions = useMemo(() => {
    ...
    const others = ANIMALS.filter(a => a.id !== correct.id).sort(() => Math.random() - 0.5).slice(0, 2)
  ...
  return (
    <Container fluid p={{ base: 'xs', md: 'lg' }} mih="100dvh">
      ...
      <Group justify="space-between" mb="sm">
        <Title order={4} c="dimmed">Level {currentLevelIdx + 1}</Title>
      ...
      <Box maw={1300} mx="auto">
        ...
        >
            ...
            {gameState === 'victory' && (
                ...
                >
                    <Title order={1} c="green" style={{ textShadow: '2px 2px white', fontSize: '3rem' }}>Kisu'lkw!</Title>
                    <Group mt="md">
                        {/* Option 1: Play same character again */}
                        <Button size="xl" onClick={restartGame}>Play Again</Button>
